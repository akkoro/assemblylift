                ...
                unsafe {
                    ...
                    extern "C" {
                        ...
                        #[cfg_attr(
                            ...
                            link_name = "akkoro:opa/module_new-policy"
                        )]
                    ...
                    match i32::from(*((ptr1 + 0) as *const u8)) {
                        ...
                        1 => Err({
                            ...
                            #[cfg(not(debug_assertions))]
                            {
                                ::core::mem::transmute::<_, PolicyError>(i32::from(
                                    *((ptr1 + 4) as *const u8),
                                )
                                    as u8)
                            }
            ...
            pub fn eval(id: &str, data: &str, input: &str) -> wit_bindgen::rt::string::String {
                ...
                unsafe {
                    ...
                    extern "C" {
                        ...
                        #[cfg_attr(
                            not(target_arch = "wasm32"),
                            link_name = "akkoro:opa/module_eval"
                        )]
...
#[doc(hidden)]
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 485] = [
    3, 0, 3, 111, 112, 97, 0, 97, 115, 109, 13, 0, 1, 0, 7, 247, 2, 1, 65, 4, 1, 66, 11, 1, 109, 2,
    ...
    114, 111, 58, 111, 112, 97, 47, 109, 111, 100, 117, 108, 101, 5, 0, 1, 65, 2, 1, 66, 11, 1,
    109, 2, 12, 105, 110, 118, 97, 108, 105, 100, 45, 119, 97, 115, 109, 13, 110, 111, 45, 101,
    110, 116, 114, 121, 112, 111, 105, 110, 116, 4, 0, 12, 112, 111, 108, 105, 99, 121, 45, 101,
    114, 114, 111, 114, 3, 0, 0, 1, 112, 115, 1, 114, 2, 2, 105, 100, 115, 11, 101, 110, 116, 114,
    121, 112, 111, 105, 110, 116, 115, 2, 4, 0, 6, 112, 111, 108, 105, 99, 121, 3, 0, 3, 1, 112,
    125, 1, 106, 1, 4, 1, 1, 1, 64, 1, 5, 98, 121, 116, 101, 115, 5, 0, 6, 4, 0, 10, 110, 101, 119,
    45, 112, 111, 108, 105, 99, 121, 1, 7, 1, 64, 3, 2, 105, 100, 115, 4, 100, 97, 116, 97, 115, 5,
    105, 110, 112, 117, 116, 115, 0, 115, 4, 0, 4, 101, 118, 97, 108, 1, 8, 3, 1, 17, 97, 107, 107,
    111, 114, 111, 58, 111, 112, 97, 47, 109, 111, 100, 117, 108, 101, 5, 0, 4, 1, 14, 97, 107,
    107, 111, 114, 111, 58, 111, 112, 97, 47, 111, 112, 97, 4, 1, 0, 69, 9, 112, 114, 111, 100,
    117, 99, 101, 114, 115, 1, 12, 112, 114, 111, 99, 101, 115, 115, 101, 100, 45, 98, 121, 2, 13,
    119, 105, 116, 45, 99, 111, 109, 112, 111, 110, 101, 110, 116, 6, 48, 46, 49, 49, 46, 48, 16,
    119, 105, 116, 45, 98, 105, 110, 100, 103, 101, 110, 45, 114, 117, 115, 116, 5, 48, 46, 56, 46,
    48, 11, 20, 1, 1, 14, 97, 107, 107, 111, 114, 111, 58, 111, 112, 97, 47, 119, 105, 116, 3, 0,
    0,
];
