        ...
        unsafe {
            ...
            match i32::from(*((ptr1 + 0) as *const u8)) {
                ...
                1 => Err({
                    ...
                    #[cfg(not(debug_assertions))]
                    {
                        core::mem::transmute::<_, PolicyError>(
...
pub static __WIT_BINDGEN_COMPONENT_TYPE: [u8; 507] = [
    ...
    97, 116, 97, 115, 5, 105, 110, 112, 117, 116, 115, 0, 115, 4, 4, 101, 118, 97, 108, 0, 1, 8, 4,
    ...
    117, 116, 115, 0, 115, 4, 4, 101, 118, 97, 108, 0, 1, 8, 3, 3, 111, 112, 97, 19, 112, 107, 103,
    58, 47, 111, 112, 97, 47, 111, 112, 97, 45, 109, 111, 100, 117, 108, 101, 5, 0, 4, 3, 111, 112,
    97, 12, 112, 107, 103, 58, 47, 111, 112, 97, 47, 111, 112, 97, 4, 1, 0, 68, 9, 112, 114, 111,
    ...
    48, 11, 17, 1, 3, 111, 112, 97, 8, 112, 107, 103, 58, 47, 111, 112, 97, 3, 0, 0,
];
